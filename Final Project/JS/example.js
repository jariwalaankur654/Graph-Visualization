...
function SelectedVertexStyle0()
{
	...
	this.strokeStyle = '#7CFC00';
	this.mainTextColor  = '#7CFC00';
	this.fillStyle   = '#696969';
}
...
{
	var matrix = "";
	//console.log("vertices" + this.vertices[0].id);
	//console.log("edges" + this.edges[0].weight);
	for (var i = 0; i < this.vertices.length; i++)
	{
...
Application.prototype.SetHandlerMode = function(mode)
{
	...
	if (mode == "default")
	{
		...
		document.getElementsByClassName('ver1')[0].style.display = "none";
		document.getElementsByClassName('ed1')[0].style.display = "none";
		document.getElementsByClassName('re1')[0].style.display = "none";
		document.getElementsByClassName('mo1')[0].style.display = "block";
	}
	else if (mode == "addGraph")
	{
		this.handler = new AddGraphHandler(this);
		document.getElementsByClassName('ver1')[0].style.display = "block";
		document.getElementsByClassName('ed1')[0].style.display = "none";
		document.getElementsByClassName('re1')[0].style.display = "none";
		document.getElementsByClassName('mo1')[0].style.display = "none";
	}
	else if (mode == "addArc")
	{
		this.handler = new ConnectionGraphHandler(this);
		document.getElementsByClassName('ver1')[0].style.display = "none";
		document.getElementsByClassName('ed1')[0].style.display = "block";
		document.getElementsByClassName('re1')[0].style.display = "none";
		document.getElementsByClassName('mo1')[0].style.display = "none";
	}
	else if (mode == "delete")
	{
		...
		document.getElementsByClassName('ver1')[0].style.display = "none";
		document.getElementsByClassName('ed1')[0].style.display = "none";
		document.getElementsByClassName('re1')[0].style.display = "block";
		document.getElementsByClassName('mo1')[0].style.display = "none";
	}
...
{
    this.canvas = this.document.getElementById('canvas');
		canvas.width  = document.getElementById('draw-page').offsetWidth - 20;
	  ...
	  //var offset = (mainContainer.offsetTop + mainContainer.offsetHeight) - (canvas.offsetTop + canvas.offsetHeight) + ($("#footerContent").css("display") === 'block' ? 0 : 24);
		//console.log(offset);
	  canvas.height = document.getElementById('draw-page').offsetHeight - 80;
...
function postLoadPage()
{
        ...
        setTimeout(function()
                   {
                        ...
                        var delta = buttonRect.right - algorithmList.offsetWidth;
												...
												console.log("button"+ buttonRect.right);
												console.log("algo"+algorithmList.offsetwidth);
                        // if (delta < 0)
                        // {
												// 	console.log("hi2");
    ...
    $.get( "/" + SiteDir +"project/cgi-bin/getPluginsList.php",
            function( data )
            {
                ...
                var loadOneScript = function()
                {
                    ...
                    {
                        var script = document.createElement('script');
                        script.src = "/" + SiteDir + "project/JS" + scriptList[1];
                        scriptList.shift();
