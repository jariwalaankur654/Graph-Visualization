...
{
  this.lineWidth   = 2;
  this.strokeStyle = 'lightblue';  //'#c7b7c7';
  this.fillStyle   = '#c7b7c7';  //'#68aeba';
  this.mainTextColor = 'darkblue';  //'#f0d543';
}
...
function SelectedVertexStyle0()
{
	...
	this.strokeStyle = 'black';  //'#f0d543';
	this.mainTextColor  = 'darkgreen';  //'#f0d543';
	this.fillStyle   = 'yellow';  //'#c7627a';
}
...
{
	this.strokeStyle = 'lightblue';  //'#c7b7c7';
	this.weightText  = '#000000';  //'#f0d543';
 	this.fillStyle   = 'lightgreen';  //'#68aeba';
 	this.textPadding = 10;
	this.textStrockeWidth = 3;
 	this.sizeOfLoop = 24;
...
//for edges dropdown menu add and remove
...
//for set vertex type ex 1,2,3..  , a,b,c,...
